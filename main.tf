module "eks" {
  ...
  subnet_ids                            = [data.aws_subnet.wrds-App-Private-1.id, data.aws_subnet.wrds-App-Private-2.id]
  control_plane_subnet_ids              = [data.aws_subnet.wrds-App-public-1.id, data.aws_subnet.wrds-App-public-2.id]
